...
# Note: Paths for SRC, DST, LIST_FILE, and GIT must be adapted to your system.
...
LIST_FILE="/Users/leasophiegrunau/Documents/Work/Bewerbungen/code-examples-sophie-grunau/automatisation/overleaf_files.txt"
...
# This script automatically commits & pushes LaTeX source to GitHub whenever Texifier (LaTex Editor) is closed,
# and mirrors selected files into a local Overleaf folder.
# To achieve this, the code is implemented in the MacOs shortcut app as an automatisation.
